...
本システムは公開されている記事・動画・音声を収集し、**本文を保存したうえで要約・台本化し、音声にして配信**します。原典の権利はそれぞれの提供元にあり、この処理は複製・翻案・公衆送信に該当し得ます。日本の著作権法には包括的なフェアユース規定がなく、要約の外部提供は著作権法 47 条の 5 が認める「軽微利用」(日本新聞協会の解説では記事本文の 5〜10% 程度)を明確に超えます。そのため機能ではなく**スコープの側で制約を置いています**。
