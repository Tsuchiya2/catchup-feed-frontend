# pulse — 運用ダッシュボード (Frontend)

<p align="center">
  <strong>毎朝10〜15分の音声ラジオ番組をポッドキャストアプリへ配信する、個人向け学習システム「pulse」の運用ダッシュボード</strong>
</p>
...
**pulse** は、旧 catchup-feed(ニュースアグリゲータ)の後継システムです。旧システムの反省 —「配信した記事数」を最適化しても要約は読まれない — を踏まえ、pulse が最適化する目標は **理解の定着** です。
